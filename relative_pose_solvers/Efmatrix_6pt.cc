...
static void compute_E_A_affine(
	Matches q, Matches qp, 			// Input points
	Affines affines,
	EmatrixSet &E, 				// Basis for E-matrix (returned)
	PolyMatrix &A, PolyDegree &degrees	// Matrix of polynomials
)
{
	...
	Eigen::Matrix<double, 6, 9> ME;

	for (int i = 0; i < 2; i++)
	{
		const double &u1 = q[i][0],
			&v1 = q[i][1],
			&w1 = q[i][2],
			&u2 = qp[i][0],
			&v2 = qp[i][1],
	...
	// Put an artificial value in 
	E(0, 0)[0] = null_space(0,0); E(0, 1)[0] = null_space(1,0); E(0, 2)[0] = null_space(2,0);
	E(1, 0)[0] = null_space(3,0); E(1, 1)[0] = null_space(4,0); E(1, 2)[0] = null_space(5,0);
	E(2, 0)[0] = null_space(6,0); E(2, 1)[0] = null_space(7,0); E(2, 2)[0] = null_space(8,0);

	E(0, 0)[1] = null_space(0, 1); E(0, 1)[1] = null_space(1, 1); E(0, 2)[1] = null_space(2, 1);
	E(1, 0)[1] = null_space(3, 1); E(1, 1)[1] = null_space(4, 1); E(1, 2)[1] = null_space(5, 1);
	E(2, 0)[1] = null_space(6, 1); E(2, 1)[1] = null_space(7, 1); E(2, 2)[1] = null_space(8, 1);

	E(0, 0)[2] = null_space(0, 2); E(0, 1)[2] = null_space(1, 2); E(0, 2)[2] = null_space(2, 2);
	E(1, 0)[2] = null_space(3, 2); E(1, 1)[2] = null_space(4, 2); E(1, 2)[2] = null_space(5, 2);
	E(2, 0)[2] = null_space(6, 2); E(2, 1)[2] = null_space(7, 2); E(2, 2)[2] = null_space(8, 2);
	...
	double AA[3][10][10])
{
	...
	PolyDegree degrees;
	EmatrixSet E;
	compute_E_A_affine(q, qp, affines, E, A, degrees);
	// print_polymatrix (A, degrees, 2);
